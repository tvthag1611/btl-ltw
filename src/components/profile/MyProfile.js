...
const fakeImg = [
  {
    titlePost: "anc",
    urlPicture: "https://upload.wikimedia.org/wikipedia/vi/1/1d/N%C6%A1i_n%C3%A0y_c%C3%B3_anh_-_Single_Cover.jpg",
    idPost: 1
  },
  {
    titlePost: "anc",
    ...
    <div className="flex flex-col image">
      ...
      <div className="avatar flex flex-col w-full">
        ...
        <div className="info">
          ...
          <div className="des">Our mission is to inspire, educate and help others to become professional and successful designers.</div>
          <div className="subcrible">38k người theo dõi • 30 người đang theo dõi</div>
        </div>
